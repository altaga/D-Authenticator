        ...
        return (
            <div id="footer-content" className="footer-style" style={{ overflowY: "hidden", overflowX: "hidden" }}>
                    ...
                    <Row style={{ fontSize: "1.2rem" }}>
                        ...
                        <Col>
                            ...
                            <div className="flexbox-style">
                                ...
                                <div>
                                    <Button style={{ width: "12vw", borderRadius: "0px 25px 25px 0px", fontSize: "1.5rem", background: `#000` }}>
                                        Subscribe
                                    </Button>
                                </div>
                            </div>
                    ...
                    <Row>
                        ...
                        <Col>
                            <div style={{ color: "white", fontWeight: "bolder", fontSize: "1.7rem", width: "40vw" }}>
                                Welcome to D - Authenticator,
                                NFTize it collectibles, sneakers, watches and more.
                            </div>
                        </Col>
                        <Col>
                            {""}
                ...
                <div id="footer-div3" style={{ paddingBottom: "2vh" }}>
                    <Row>
                        <Col>
                            Build on <img alt="imagens" src={polygon} height="20px" /> powered by<img alt="imagsens" src={ipfs} height="20px" /> pumped by <img alt="imagens" src={moralis} height="20px" />
                        </Col>
                        <Col>
