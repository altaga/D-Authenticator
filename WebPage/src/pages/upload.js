...
class Upload extends Component {
    ...
    createContract() {
        ...
        deploy_contract.deploy(payload).send(parameter, (err, transactionHash) => {
            ...
            myHeaders.append("X-API-Key", "m9N2QaqpjstRatg7qJFFMebq6qrggD1jSpsV0NlnelPOKd4wp3wvGNV5T7xC5kUF");
    ...
    mintNFT() {
        ...
        mint_contract.methods.mintNFT(this.props.my_ipfslink.ipfslink.nft, (this.state.price * unitMap['ether']).toString()).send().on('transactionHash', (hash) => {
            this.unirest('GET', 'https://xxxxxxxxxx.execute-api.us-east-1.amazonaws.com/pubDB')
                .headers({
                    'pubkey': this.props.my_pubkey.pubkey,
                    ...
                    <div>
                        ...
                        }
                        {
                            ...
                            <div style={{ paddingTop: "4vh", width: "98%" }}>
                                ...
                                <Row md="2">
                                    ...
                                    <Col xs={6} style={{ background: "white", color: "black" }}>
                                    <br />
                                        <h2>Sell</h2>
                                        <p />
                                        <div>
                                ...
                                <br />
                                <Button onClick={() => this.props.set_activetab_action(2)} style={{ width: "200px", borderRadius: "25px 25px 25px 25px", fontSize: "1.5rem", background: `#000` }}>
                                    Continue
                                </Button>
                                <br/>
                                <br/>
                        ...
                        }
                        {
                            ...
                            <div style={{ paddingTop: "5vh" }}>
                                ...
                                <p />
                                <Button id="button-upload1" color="primary" style={{ fontSize: "1.5rem", borderRadius: "25px", background: ` #000` }} onClick={() => {
                        ...
                        }
                        {
                            ...
                            <div style={{ paddingTop: "12vh" }}>
                                <SimpleReactFileUpload url={"	https://xxxxxxxxxx.execute-api.us-east-1.amazonaws.com/upload-NFT-Storage"} />
                            </div>
                        }
                        {
                            ...
                            <div className="flexbox-style3">
                                <div style={{ paddingTop: "2vh" }}>
                                    ...
                                    {`MATIC value: ${this.state.price}`}
                                    <p />
                                    <Button disabled={this.state.mintButton} id="upload3" color="primary" style={{ fontSize: "1.5rem", borderRadius: "25px", background: ` #000` }} onClick={() => {
                                        this.setState({ mintButton: true });
                        ...
                        }
                        {
                            ...
                            <>
                                ...
                                <div style={{ paddingTop: "3vh" }}>
                                    <Button style={{ borderRadius: "25px 0px 0px 25px", fontSize: "1.5rem", borderRight: "1px solid black", background: ` #000` }} onClick={() => window.open(this.state.finalUrl, "_blank")}>View on PolygonScan</Button>
                                    {
                                        console.log(this.state.finalUrl)
                                    }
                                    <Button style={{ borderRadius: "0px 25px 25px 0px", fontSize: "1.5rem", background: ` #000` }} onClick={() => window.open(`/nft/${this.props.my_pubkey.pubkey}?id=${this.state.nftNumber}`, "_blank")}>View on Marketplace</Button>
                                </div>
                            </>
                        }
                    </div>
