          ...
          <div>
            <Row style={{ paddingBottom: "13vh" }}>
              <Col style={{ paddingTop: "14vh", paddingLeft: "12vw" }}>
                ...
                <h5>
                  <p />NFTize it collectibles, sneakers, watches and more.
                </h5>
                <br />
                <Row>
                  <Col>
                    <div style={{ width: "90%", paddingLeft: "5%" }} className="flexbox-style">
                      ...
                      <Button
                        ...
                        style={{ width: "200px", borderRadius: "0px 25px 25px 0px", fontSize: "1.5rem", background: `#000` }}>Search</Button>
                    </div>
                  ...
                  if (index < 3) {
                    return (
                      <div key={"element" + index} style={{ margin: "10px", height: "74vh" }}>
                        <Card id={"cards" + index} style={{ width: "20vw", height: "74vh", border: "black 1px solid" }}>
                          <div style={{ opacity: "100%", textAlign: "center", paddingTop: "10px" }} >
                            <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={item.Url} alt="Card image cap" />
                          </div>
                          <br />
                          <CardBody>
                            ...
                            <div className="flexbox-style">
                              <div style={{ position: "absolute", bottom: "2vh" }}>
                                <Button style={{ width: "200px", borderRadius: "25px", fontSize: "1.3rem", background: ` #000` }} onClick={() => {
              ...
              <Row md="3" style={{ padding: "4vh" }}>
                <Col>
                  <div style={{ paddingBottom: "10px" }}>
                    <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={one} alt="Card image cap" />
                  </div>
                ...
                <Col>
                  <div style={{ paddingBottom: "10px" }}>
                    <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={two} alt="Card image cap" />
                  </div>
                  <div style={{ padding: "0px 20px 0px 20px" }}>
                ...
                <Col>
                  <div style={{ paddingBottom: "10px" }}>
                    <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={three} alt="Card image cap" />
                  </div>
                  <div style={{ padding: "0px 20px 0px 20px" }}>
                ...
                <Col>
                  <div style={{ paddingBottom: "10px", paddingTop: "20px" }}>
                    <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={four} alt="Card image cap" />
                  </div>
                  <div style={{ padding: "0px 20px 0px 20px" }}>
                ...
                <Col>
                  <div style={{ paddingBottom: "10px", paddingTop: "20px" }}>
                    <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={five} alt="Card image cap" />
                  </div>
                  <div style={{ padding: "0px 20px 0px 20px" }}>
                ...
                <Col>
                  <div style={{ paddingBottom: "10px", paddingTop: "20px" }}>
                    <CardImg style={{ width: "190px", height: "190px", borderRadius: "10px", border: "black 1px solid" }} top src={six} alt="Card image cap" />
                  </div>
                  <div style={{ padding: "0px 20px 0px 20px" }}>
