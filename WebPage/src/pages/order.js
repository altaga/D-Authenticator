                                                    ...
                                                    <Card key={index + "element"} style={{ margin: "6px" }}>
                                                        ...
                                                        <CardBody>
                                                            ...
                                                            <div style={{ height: "1vh" }} />
                                                            {
                                                                ...
                                                                <Button disabled={!parseInt(this.state.generalOrders[element.PubKey].state)} style={{ width: "200px", borderRadius: "25px", fontSize: "1.3rem", background: ` #000` }} onClick={() => {
                                                                    this.setState({
                                ...
                                <Row>
                                    <Col xs="3">
                                        ...
                                        <Button
                                            ...
                                            style={{ width: "200px", borderRadius: "25px", fontSize: "1.5rem", background: ` #000` }}>
                                            Order NOW
                                        </Button>
                                    </Col>
                                    <Col xs="9">
