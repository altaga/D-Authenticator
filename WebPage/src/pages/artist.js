          ...
          this.state.elements.length > 0 ?
            <div className="body-style" id="body-style">
              <div style={{ paddingTop: "40px" }}>
                ...
                <Col>
                  <Button style={{ width: "16vw", borderRadius: "10px", fontSize: "1.5rem", borderRight: "1px solid black", background: ` #000`, marginRight: "10px" }} onClick={() => window.open(JSON.parse(this.state.elements[0].Data).external_url, "_blank")}>Artist URL</Button>
                  {
                    this.props.my_pubkey.pubkey === this.props.match.params.pub &&
                    <Button disabled={!this.state.buttonDisabled} style={{ width: "16vw", borderRadius: "10px", fontSize: "1.5rem", background: ` #000` }} onClick={this.toogleStateOrders}>{this.state.LabelOrder}</Button>
                  }
                  <Button style={{ marginLeft: "10px", width: "16vw", borderRadius: "10px", fontSize: "1.5rem", background: ` #000` }} onClick={() => window.open(`https://mumbai.polygonscan.com/address/${this.props.match.params.pub}`, "_blank")}> View on Etherscan</Button>
                </Col>
                {
                  this.props.my_pubkey.pubkey === this.props.match.params.pub &&
                  <h3 style={{ paddingTop: "4vh" }}>
                    <Button disabled={!this.state.pendingButton} style={{ width: "16vw", borderRadius: "10px", fontSize: "1.5rem", background: ` #000` }} onClick={() => {
                      //pending
                        ...
                        <div key={"element" + index} style={{ margin: "10px" }}>
                          <Card style={{ width: "15vw", height: "34vh" }}>
                            ...
                            <CardBody>
                              ...
                              <Button style={{ width: "200px", borderRadius: "25px", fontSize: "1.5rem", background: ` #000` }} onClick={() => {
